...
const TransactionModal = ({open,setOpen}) => {
    return (
        <div>
              <Modal
        centered
      ...
      <h1 className=' font-semibold text-xl text-center py-3'>Transaction Details</h1>
        <div className="p-6 flex flex-col justify-start gap-2 pt-8">
          <div className="flex justify-between items-center">
            <p className="text-[#000000] text-sm whitespace-nowrap">Transaction ID: </p>
